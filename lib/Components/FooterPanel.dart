...
class FooterPanel extends StatelessWidget {
  ...
  Widget UsefulLink() =>
      Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
        ...
        TextButtons('About Us', Colors.grey),
        TextButtons('Blog', Colors.grey),
        TextButtons('Github', Colors.grey),
        TextButtons('Free Products', Colors.grey)
      ]);
  Widget OtherResources() => Column(
        crossAxisAlignment: CrossAxisAlignment.center,
        children: [
          TextButtons('Terms & Conditions', Colors.grey),
          TextButtons('Privacy Policy', Colors.grey),
          TextButtons('Contact Us', Colors.grey)
        ],
      );
}
